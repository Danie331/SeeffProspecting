...
function buildSearchMenu() {
    ...
    searchDiv.append("<label class='fieldAlignmentShortWidth' for='deedTownInput'>Deed Town</label>\
                      ...
                      <hr />\
                      <label class='fieldAlignmentShortWidth' for='ownerFirstNameInput' style='display:none'>Owner Firstname</label>\
                      <input type='text' name='ownerNameInput' id='ownerFirstNameInput' size='30' style='height:12px;font-size:12px;display:none' onkeypress='return searchLightstoneOnEnter(event);' /><p style='margin:3px;' />\
                      <label class='fieldAlignmentShortWidth' for='ownerSurnameInput' style='display:none'>Owner Surname</label>\
                      <input type='text' name='ownerNameInput' id='ownerSurnameInput' size='30' style='height:12px;font-size:12px;display:none' onkeypress='return searchLightstoneOnEnter(event);' /><p style='margin:3px;' />\
