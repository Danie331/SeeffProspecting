USE [ls_base]
GO
/****** Object:  UserDefinedFunction [dbo].[point_inside_poly]    Script Date: 2014/02/18 02:43:57 PM ******/

ALTER function [dbo].[point_inside_poly](@point_lat decimal(13,8), @point_lng decimal(13,8), @polygon_coords varchar(max))
returns int
as
begin
	DECLARE @g geography;
