...
/****** Object:  StoredProcedure [dbo].[sp_load_new_lightstone_data_step_1]    Script Date: 2014-08-20 06:33:57 PM ******/
SET ANSI_NULLS ON
GO
...
create procedure [dbo].[sp_load_new_lightstone_data_step_1]
as
begin
