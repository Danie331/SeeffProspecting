...
-- =============================================
CREATE PROCEDURE [dbo].[sp_update_search_table_by_date]
...
FROM [seeff].[dbo].[search] 
JOIN [seeff].[dbo].[property]
on [seeff].[dbo].search.searchReference = property.propertyReference
WHERE [seeff].[dbo].[property].[propertyLastUpdated] > @lastSyncTime
...
AND [seeff].[dbo].[property].[propertyLastUpdated] > @lastSyncTime
...
--Fix for getareapathmap insert issue
UPDATE search SET 
searchCountry = [dbo].[GetAreaPathMap](fkAreaId, 1),
searchProvince = [dbo].[GetAreaPathMap](fkAreaId, 2),
searchRegion = [dbo].[GetAreaPathMap](fkAreaId, 3),
searchCity = [dbo].[GetAreaPathMap](fkAreaId, 4),
searchArea = [dbo].[GetAreaPathMap](fkAreaId, 5),
searchSuburb = [dbo].[GetAreaPathMap](fkAreaId, 6)
WHERE searchCountry = -1
