...
-- Description:	License Sales Report
--				Division Summary Sheet
--				2012-03-02: CHANGED CALCULATION
--				OF PERCENTAGE COMMISSION
-- =============================================
CREATE PROCEDURE [dbo].[spMIS_Lic_CanTran_DivSum]
...
SELECT   
			 ...
			 , SUM(dbo.sales_actual_selling(sps_tran.sps_refferal_type, 
											...
											sps_tran.sps_selling_price)) AS [Total ActualSelling]
			 , SUM(dbo.sales_comm_at_seven(sps_tran.sps_refferal_type, 
										   sps_tran.sps_referral_comm, 
										   sps_tran.sps_comm_amount)) AS [Sales AtSeven Perc]
