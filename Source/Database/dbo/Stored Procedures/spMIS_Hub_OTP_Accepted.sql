...
-- Description:	Returns all OTP Accepted status
--				Hub transactions
--				Irrespective of date created
-- =============================================
CREATE PROCEDURE [dbo].[spMIS_Hub_OTP_Accepted] 
...
SELECT
						UR.user_preferred_name + ' ' + UR.user_surname AS [Created By]
