...
--				INCOMING referrals
-- =============================================
CREATE PROCEDURE [dbo].[spMIS_Referrals_InComing]
...
BEGIN
	...
	SELECT		  
				...
				, dbo.get_entity_desc(sm_pa.from_entity_type, sm_pa.from_entity_id)AS [Agent From]
...
-- Incoming Referrals: license.license_id AS id_to
WHERE 
