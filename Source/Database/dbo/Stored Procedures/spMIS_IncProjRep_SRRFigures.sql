...
-- =============================================
CREATE PROCEDURE [dbo].[spMIS_IncProjRep_SRRFigures] 
...
WHERE 
		license.license_id 
NOT IN 
		(SELECT #SRR_Results.LicenseID FROM #SRR_Results) AND license.Status LIKE 'A' AND license.license_id NOT IN (109,107)

select * FROM #SRR_Results ORDER BY Region,License
