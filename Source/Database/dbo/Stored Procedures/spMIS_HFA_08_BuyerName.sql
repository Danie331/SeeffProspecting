...
--				Returns exceptions on Hub records
--				where no Buyer name has been entered
-- =============================================
CREATE PROCEDURE [dbo].[spMIS_HFA_08_BuyerName] 
...
BEGIN
	...
	CREATE NONCLUSTERED INDEX Indx02 ON [dbo].[sps_person] ([sps_person_id])
	CREATE NONCLUSTERED INDEX Indx03 ON [dbo].[persons_in_transaction] ([transaction_guid],[person_roll]) INCLUDE ([person_id]) 
...
DROP INDEX Indx02 ON [dbo].[sps_person] 
